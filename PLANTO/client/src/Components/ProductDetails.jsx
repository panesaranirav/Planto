              ...
              <span className="flex ml-3 pl-3 py-2 border-l-2 border-gray-200 space-x-2">
                ...
                <a className="text-gray-500" href="#">
                  <svg
                    ...
                    viewBox="0 0 24 24"
                  >
                    <path d="M21 11.5a8.38 8.38 0 01-.9 3.8 8.5 8.5 0 01-7.6 4.7 8.38 8.38 0 01-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 01-.9-3.8A8.5 8.5 0 018.7 3.9 8.38 8.38 0 0112.5 3h.5a8.48 8.48 0 018 8v.5z" />
                  </svg>
                </a>
              </span>
            </div>
